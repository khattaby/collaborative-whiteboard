...
export default async function ProfilePage() {
  ...
  return (
    <div className="min-h-screen bg-green-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md mx-auto bg-white rounded-xl shadow-md overflow-hidden md:max-w-2xl border border-green-100">
        <div className="md:flex">
          <div className="p-8 w-full">
            ...
            <div className="mt-6 space-y-6">
              ...
              <div className="flex space-x-4 mt-6 pt-4 border-t border-green-100">
                <form
                  action={async () => {
                    "use server";
